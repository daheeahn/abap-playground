...
FORM build_fieldcatalog.
  ...
  fieldcatalog-lzero        = 'X'. "옵션 추가 - 앞에 0 표시되도록
  APPEND fieldcatalog TO fieldcatalog.
  CLEAR  fieldcatalog.
  ...
  fieldcatalog-edit_mask    = '__________'. "옵션 추가 - 10자리 확보
  APPEND fieldcatalog TO fieldcatalog.
  CLEAR  fieldcatalog.
  ...
  fieldcatalog-decimals_out = 0. "옵션 추가 - 소수점 없도록
  APPEND fieldcatalog TO fieldcatalog.
  CLEAR  fieldcatalog.
